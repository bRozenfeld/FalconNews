...
function updateFeeders(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    for (var j=1; j < col.length; j++) {
      ...
      var strHtml = "<button id=" + data[i][col[j-1]] + " onclick='javascript:location.reload(false),deleteFeeder(this.id)' class='btn btn-danger'><span class='icon'><i style=color:red class='fas fa-trash'></i></span></button>";
